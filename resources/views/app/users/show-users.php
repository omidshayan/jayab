...
include_once('resources/views/scripts/live-search-user-details.php');
?>
...
<div class="content">
    ...
    <div class="flex-justify-align mb10">
        <div class="border search-database-s flex-justify-align">
            ...
            <input type="text" class="p5 fs15 input w100" id="search_item" placeholder="جستجوی کاربر..." autocomplete="off" autofocus />
    ...
    <div class="box-container">
        <table class="fl-table">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td class="color-orange <?= statusColor($user['status']) ?>"><?= $number ?></td>
