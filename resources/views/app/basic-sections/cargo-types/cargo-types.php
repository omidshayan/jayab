...
<div class="content">
    <div class="content-title"> مدیریت نوعیت بار‌ها
    ...
    <div class="box-container">
        <div class="insert">
            <form id="myForm" action="<?= url('cargo-type-store') ?>" method="POST">
                <div class="inputs d-flex">
                    <div class="one">
                        <div class="label-form mb5 fs14">نام نوعیت <?= _star ?> </div>
                        <input type="text" name="type_name" class="checkInput" value="<?= old('name') ?>" placeholder="نام نام نام نوعیت را وارد نمایید" autocomplete="off" />
                    </div>
                </div>
    ...
    <div class="box-container">
        <div class="mb10 fs14"> نوعیت‌های ثبت شده</div>
        <table class="fl-table">
            ...
            <tbody>
                <?php
                $perPage = 10;
                $data = paginate($cargo_types, $perPage);
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url('edit-cargo-type/' . $item['id']) ?>" class="color-orange">
                        ...
                        <td>
                            <a href="<?= url('cargo-type-details/' . $item['id']) ?>">
        ...
        <div class="flex-justify-align mt20 paginate-section">
            <div class="table-info fs12">تعداد کل: <?= count($cargo_types) ?></div>
            <?php
            if (count($cargo_types) == null) { ?>
                <div class="center color-red fs12">
                    <i class="fa fa-comment"></i>
                    <?= _not_infos ?>
                </div>
            <?php } else {
                if (count($cargo_types) > 10) {
                    echo paginateView($cargo_types, 10);
                }
            }
            ?>
        </div>
