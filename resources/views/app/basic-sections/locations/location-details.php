    <?php
    $title = 'جزئیات موقعیت: ' . $item['location_name'];
    ...
    <div class="content">
        <div class="content-title"> جزئیات موقعیت: <?= $item['location_name'] ?></div>

        <div class="box-container">
            <div class="details">
                <div class="detail-item d-flex">
                    <div class="w100 m10 center">نام</div>
                    <div class="w100 m10 center"><?= $item['location_name'] ?></div>
                </div>
            </div>
            <div class="details">
                <div class="detail-item d-flex">
            ...
            <div class="details">
                <div class="detail-item d-flex">
                    <div class="w100 m10 center">
                        ...
                        <div class="w100 m10 center">
                            <td>
                                <a href="#" data-url="<?= url('change-status-location') ?>" data-id="<?= $item['id'] ?>" class="changeStatus color btn p5 w100 m10 center">تغییر وضعیت</a>
                            </td>
                        </div>
                    </div>
