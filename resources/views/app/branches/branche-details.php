    <?php
    $title = 'جزئیات شعبه: ' . $item['branch_name'];
    ...
    <div class="content">
        <div class="content-title"> جزئیات شعبه: <?= $item['branch_name'] ?></div>
        <div class="box-container">
            <div class="details">
                <div class="detail-item d-flex">
                    <div class="w100 m10 center">نام</div>
                    <div class="w100 m10 center"><?= $item['branch_name'] ?></div>
                </div>
            </div>
            <div class="details">
                <div class="detail-item d-flex">
                    <div class="w100 m10 center">شماره اول</div>
                    <div class="w100 m10 center"><?= ($item['phone'] ?: '- - -') ?></div>
                </div>
            </div>
            <div class="details">
                <div class="detail-item d-flex">
                    <div class="w100 m10 center">شماره دوم</div>
                    <div class="w100 m10 center"><?= ($item['phone2'] ?: '- - -') ?></div>
                </div>
            </div>
                        <div class="details">
                <div class="detail-item d-flex">
                    <div class="w100 m10 center">آدرس</div>
                    <div class="w100 m10 center"><?= ($item['address'] ?: '- - -') ?></div>
                </div>
            </div>
            <div class="details">
                <div class="detail-item d-flex">
            ...
            <div class="details">
                <div class="detail-item d-flex">
                    <div class="w100 m10 center">
                        <div class="w100 m10 center">
                            <td>
                                <a href="#" data-url="<?= url('change-status-branch') ?>" data-id="<?= $item['id'] ?>" class="changeStatus color btn p5 w100 m10 center">تغییر وضعیت</a>
                            </td>
                        </div>
                    </div>
