...
<div class="content">
    <div class="content-title"> مدیریت شعبات
            ...
            <form action="branch-store" method="POST">
                <div class="inputs d-flex">
                    <div class="one">
                        ...
                        <input type="text" name="branch_name" class="checkInput" value="<?= old('name') ?>" placeholder="نام شعبه را وارد نمایید" autocomplete="off" autofocus />
                    </div>
                </div>
                <div class="inputs d-flex">
                    <div class="one">
                        <div class="label-form mb5 fs14">شماره</div>
                        <input type="text" name="phone" value="<?= old('name') ?>" placeholder="شماره دوم شعبه را وارد نمایید" autocomplete="off" autofocus />
                    </div>
                    <div class="one">
                        <div class="label-form mb5 fs14">شماره دوم</div>
                        <input type="text" name="phone2" value="<?= old('name') ?>" placeholder="شماره شعبه را وارد نمایید" autocomplete="off" autofocus />
                    </div>
                </div>
                <div class="inputs d-flex">
                    <div class="one">
                        <div class="label-form mb5 fs14">آدرس</div>
                        <textarea name="address" id="" placeholder="آدرس شعبه را وارد نمائید"></textarea>
                    </div>
                </div>
    ...
    <div class="box-container">
        <div class="mb10 fs14"> شعبات ثبت شده</div>
        <table class="fl-table">
            ...
            <tbody>
                <?php
                $perPage = 10;
                $data = paginate($branches, $perPage);
                ...
                ?>
                    <tr>
                        ...
                        <td><?= ($item['phone2']) ?: '- - -' ?></td>
                        <td>
                            <a href="<?= url('edit-branch/' . $item['id']) ?>" class="color-orange">
                        ...
                        <td>
                            <a href="<?= url('branch-details/' . $item['id']) ?>">
        ...
        <div class="flex-justify-align mt20 paginate-section">
            <div class="table-info fs12">تعداد کل: <?= count($branches) ?></div>
            <?php
            if (count($branches) == null) { ?>
